...
module.exports = {
    googleOptions: {
        ...
        callbackURL: config.hostAddress + '/auth/google/callback',
        passReqToCallback: true
    },
    facebookOptions: {
        clientID: '1492797114115423',
        clientSecret: '4853afb46acb6b1286d4ca0bdbbe49c2',
        callbackURL: config.hostAddress + '/auth/facebook/callback',
    ...
    twitterOptions: {
        ...
        callbackURL: config.hostAddress + 'auth/twitter/callback',
        includeEmail: true,
        passReqToCallback: true
    }
};
